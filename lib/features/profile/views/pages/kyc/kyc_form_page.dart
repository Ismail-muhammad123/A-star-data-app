...
// import 'package:tubali_app/core/permission_services.dart';
// import 'package:tubali_app/features/auth/providers/auth_provider.dart';
// import 'package:tubali_app/features/profile/data/models/kyc_data_model.dart';
...
//     "national_id": "National Identification Number (NIN)",
...
//         _idNumberController.text = res?.idNumber ?? "";
//         selectedIDMethod = res?.idType ?? "national_id";
//       });
//     } catch (e) {
//       if (mounted) {
...
//         idType: selectedIDMethod ?? "national_id",
//       );
...
//                       SizedBox(height: 10),
//                       Text(
//                         "Your KYC Data has been recieved successfully. You will be notified after the we finish reviewing your information",
...
//                     color: const Color.fromARGB(255, 230, 254, 200),
...
//                         )
//                         .toList(),
//                 onChanged: _editing && !_isLoading ? (value) {} : null,
//               ),
//               const SizedBox(height: 16),
//               TextFormField(
//                 enabled: _editing && !_isLoading,
