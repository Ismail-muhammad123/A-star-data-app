...
class _UpgradeRolePageState extends State<UpgradeRolePage> {
  ...
  Future<void> _handleUpgrade() async {
    ...
    final feeInfo = _feesResponse?.availableUpgrades
        .firstWhere((element) => element.toRole == _selectedRole);
              ...
              child: Column(
                ...
                children: [
                   ...
                   Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.star_rounded, color: Colors.blueAccent, size: 40),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: (isSoon ? Colors.grey : Colors.blueAccent).withOpacity(0.1),
                                  shape: BoxShape.circle,
                                ),
                                child: Icon(
                                  upgrade.toRole == 'agent' ? Icons.handshake_outlined : Icons.code_rounded,
                                  color: isSoon ? Colors.grey : Colors.blueAccent,
                                ),
                              ),
                              const SizedBox(width: 15),
                              Expanded(
                                      ...
                                      children: [
                                        Text(
                                          ...
                                          style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 16,
                                            color: isSoon ? Colors.grey : Theme.of(context).textTheme.bodyLarge?.color,
                                          ),
                                        ),
                                        if (isSoon) ...[
                              ...
                              Text(
                                NumberFormat.currency(symbol: "₦", decimalDigits: 0).format(double.tryParse(upgrade.fee) ?? 0),
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: (_selectedRole == null || _isUpgrading) ? null : _handleUpgrade,
