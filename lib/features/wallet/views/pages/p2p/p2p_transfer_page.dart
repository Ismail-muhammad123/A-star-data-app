...
import 'package:app/features/settings/views/widgets/pin_entry_dialog.dart';
  ...
  Future<void> _executeTransfer(String pin) async {
    ...
    try {
      ...
      await P2PService().executeTransfer(
        ...
        recipientIdentifier: _recipient!['identifier'],
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.account_balance_wallet_outlined, color: Colors.blueAccent),
                    const SizedBox(width: 12),
                    const Text("Balance: ", style: TextStyle(fontWeight: FontWeight.w500)),
                    Text(
                      NumberFormat.currency(locale: 'en_NG', symbol: '₦').format(wallet.balance),
              ...
              if (_recipient != null) ...[
                ...
                TextFormField(
                  ...
                  decoration: _inputDecoration(hint: "What's this for?", icon: Icons.note_add_outlined),
                ),
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Text(recipient['full_name'][0].toUpperCase(), style: const TextStyle(color: Colors.white)),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(recipient['full_name'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                Text("@${recipient['identifier']}", style: const TextStyle(color: Colors.grey, fontSize: 13)),
              ],
            ),
          ),
